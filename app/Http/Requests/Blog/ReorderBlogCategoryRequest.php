...
class ReorderBlogCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.id' => ['required', 'integer', 'distinct', 'exists:blog_categories,id'],
            'items.*.sort_order' => ['required', 'integer', 'min:1', 'distinct'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.id.exists' => 'The selected category does not exist.',
