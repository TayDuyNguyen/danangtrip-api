...
class SystemOverviewExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        return [
            ...
            new class($this->data['revenue']) implements FromArray, WithHeadings, WithTitle
            {
            ...
            new class($this->data['booking_trend']) implements FromArray, WithHeadings, WithTitle
            {
            ...
            new class($this->data['user_growth']) implements FromArray, WithHeadings, WithTitle
            {
            ...
            new class($this->data['top_tours']) implements FromArray, WithHeadings, WithTitle
            {
            ...
            new class($this->data['top_locations']) implements FromArray, WithHeadings, WithTitle
            {
