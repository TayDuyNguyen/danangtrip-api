                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #dbe6f1">
                                    ...
                                    <tr>
                                        <td style="padding:30px 32px 34px;background:#ffffff">
                                            ...
                                            <p style="margin:0;color:#0f172a;font-size:16px;line-height:1.75">
                                                We received a request to reset your {$appName} password.
                                            </p>
                                            <a href="{$safeUrl}" style="display:inline-block;margin-top:22px;padding:13px 20px;border-radius:999px;background:#14b8a6;color:#06221f;text-decoration:none;font-size:14px;font-weight:800">
                                                Reset password
                                            </a>
